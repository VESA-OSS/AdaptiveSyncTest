...
namespace DX
{
    ...
    public:
        ...
        {
            if (!QueryPerformanceFrequency(&m_qpcFrequency))            // initialize frequency (from this machine)
            {
                throw std::exception( "QueryPerformanceFrequency" );
            }

            if (!QueryPerformanceCounter(&m_qpcLastTime))               // initialize last-called timer
            {
        ...
        // Update timer state, calling the specified Update function the appropriate number of times.  WHY THO?
